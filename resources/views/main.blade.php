...
<head>
  ...
  <title>Sistem Informasi Gereja Methodist</title>
...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">Sistem Informasi Gereja Methodist</h1>
      </a>
  ...
  <footer id="footer" class="footer dark-background">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="logo d-flex align-items-center">
            <span class="sitename">Sistem Informasi Gereja Methodist</span>
          </a>
    ...
    <div class="container copyright text-center mt-4">
      <p><strong class="px-1 sitename">Gereja Methodist</strong></p>
    </div>
